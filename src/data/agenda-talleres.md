...
Escribe `Sí` para mostrar los bloques de la agenda o `No` para mostrar únicamente el mensaje alternativo.
...
Separa cada fecha con punto y coma. Las filas con `No` se conservan como borradores.
